                        ...
                        <?php foreach ($slider1_pics as $pic) { ?>		
                            <li><div class="item">
                                    ...
                                    <div class="item-content">
                                        ...
                                        <img style="margin-left:-14px;cursor:auto; margin-top:-7px;" src="<?php echo base_url(); ?>public/original/<?php echo $pic->main_photo; ?>"  alt='<?php echo $pic->name ?>' width='196' height='152' />											
                                    </div> <!-- .item-content -->
