...
<div id="adv_content">
    <div class="boxLeft">
            ...
            <div style="float:left;margin-top:3px;margin-right:50px;">
        <a  name="fb_share"  type="button" share_url="http://daliltanta.com/site/showGoldenAdvDetail/<?php foreach ($res as $s) {  echo $s->id;} ?>">FShare</a> 
<script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript">
            ...
            <iframe  src="https://www.facebook.com/plugins/like.php?href=http://daliltanta.com/site/showGoldenAdvDetail/<?php foreach ($res as $s) {  echo $s->id;} ?>"
